...
import com.notify.security.JwtAuthFilter;
import com.notify.security.UserDetailsServiceImpl;
 ...
 *
 * Key decisions:
 * - STATELESS sessions: No server-side session, JWT is the source of truth
 * - CORS: Configured to allow the React frontend
 * - Public routes: /api/auth/** (login/register) and /ws/** (WebSocket)
